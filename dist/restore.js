import { g as getDefaultExportFromCjs, e as error, a as getCacheProvider, b as getInput, c as exportVariable, C as CacheConfig, i as info, d as cleanTargetDir, r as reportError, s as setOutput } from './cleanup-22Mlm2bq.js';
import * as fs from 'fs';
import { r as requireForm_data, a as requireDist, b as requireFollowRedirects } from './index-Di22Ls3Z.js';
...
var URLSearchParams = require$$2.URLSearchParams;
...
class AxiosTransformStream extends require$$0__default.Transform {
  constructor(options) {
...
const textEncoder = typeof TextEncoder === 'function' ? new TextEncoder() : new require$$0__default$1.TextEncoder();
...
class ZlibHeaderTransformStream extends require$$0__default.Transform {
    ...
    if (authoritySessions) {
      ...
      for (let i = 0; i < len; i++) {
        ...
        if (
          ...
          require$$0__default$1.isDeepStrictEqual(sessionOptions, options)
        ) {
...
function getProxyEnvAgent(options, configHttpAgent, configHttpsAgent) {
  return isHttps.test(options.protocol)
    ? configHttpsAgent || https__default.globalAgent
    : configHttpAgent || http__default.globalAgent;
}
  ...
  function httpAdapter(config) {
    return wrapAsync(async function dispatchHttpRequest(resolve$1, reject, onDone) {
      ...
      onDone((response, isRejected) => {
        ...
        if (data instanceof require$$0__default.Readable || data instanceof require$$0__default.Duplex) {
          const offListeners = require$$0__default.finished(data, () => {
            offListeners();
            onFinished();
          });
        } else {
      ...
      if (protocol === 'data:') {
        ...
        if (responseType === 'text') {
          ...
          convertedData = require$$0__default.Readable.from(convertedData);
        }
      ...
      if (utils$1.isSpecCompliantForm(data)) {
        ...
        if (!headers.hasContentLength()) {
          try {
            const knownLength = await require$$0__default$1.promisify(data.getLength).call(data);
        ...
        data = require$$0__default.Readable.from(readBlob(data));
      ...
      if (data && (onUploadProgress || maxUploadRate)) {
        if (!utils$1.isStream(data)) {
          data = require$$0__default.Readable.from(data, { objectMode: false });
        }

        data = require$$0__default.pipeline(
          [
            data,
      ...
      if (isHttp2) {
        ...
        if (configTransport) {
          ...
          transport = isHttpsRequest ? https__default : http__default;
      ...
      req = transport.request(options, function handleResponse(res) {
        ...
        responseStream = streams.length > 1 ? require$$0__default.pipeline(streams, utils$1.noop) : streams[0];
        ...
        if (responseType === 'stream') {
          ...
          if (maxContentLength > -1) {
            ...
            responseStream = require$$0__default.Readable.from(enforceMaxContentLength(), {
              objectMode: false,
            });
          }
      ...
      if (utils$1.isStream(data)) {
        ...
        if (maxBodyLength > -1 && !transportEnforcesMaxBodyLength) {
          ...
          let bytesSent = 0;
          uploadStream = require$$0__default.pipeline(
            [
              data,
              new require$$0__default.Transform({
